FdvBDcYbo40I5l2WYxMK8EI2OCEJpiCy4KDImvEi9yf-Dd2Pepc3AaAawfyXBBQSQRse1g_Ksgf9jIdJPJiMAuQ9SQq4sMCs3A1s7mFGmUgJv8C2cfKWXtKxNPttqiqq_WqYHHJEkwMBS-bJAlh1M4kwtRW5kjwoudMJyrbGt7UBTFc-QPBSA9cW9ts9EICofGwocq4UNEOGL_5P9BjGtnFH1KX7q8N_0WdWAiEvyLQiWopgc8rmIw9htwKHMARpkKJomVe66Xs1aJMgvhH_l1Yv9n6LEJIT6gda8fOEaQ087C5owfQTKEbjUQA_M3Lpynw2fzzXpKso445HF3-3zAEc733Du2SpweaH528cANTcfNRcJdzjxEtEY0HBwueZqIuJkC_p5iI56CoZl3g3obgBxwshX6l668ZhVspYxSRtTbP-0-jxCzqDnaKtK_W6jgR-pKZI5_2x7F4FlNIrSmkBDJOkV4ZVVjQjyxF_R7Pgya9A66WlPLIz4ZzIV21H_i2duBT71ZO5YuNtO9hk2s0ZS4mGCQkv6R01dClN4Jc3btrzMzHN0Dy13x1-IbVN0_owsuwp8H1lxBSNdPwSWBtw-RIddXk9BlvPMApRMf-2w3qtpVhSIoEpQrHbDefZQAifak2m8zmk2OYGG-V_y0))
```
...
Rest API, потому что синхронный тип взаимодействия оптимально решит вопрос с мгновенным доступом пользователей к ресурсам управления умного дома

### 2. Документация API

Здесь приложите ссылки на документацию API для микросервисов, которые вы спроектировали в первой части проектной работы. Для документирования используйте agger/OpenAPI или AsyncAPI.

Прилагаю Swagger для 5 микросервисов (все кроме API Geteway, потому что его методы по факту проксирующие и вызываются с UI, а задача предполагает описание взаимодействия между микросервисами back to back) ./FitLife/swagger.yaml

# Задание 5. Работа с docker и docker-compose

1) Итог: 
Приложение temperature-api находится в ./FitLife/src/main/temperature-api
2) Итог: 
docker-compose находится в ./FitLife/src/main/docker-compose.yml
3) Кроме того для smart_home приложения требуется база данных - добавьте в docker-compose файл настройки для запуска postgres с указанием скрипта инициализации ./smart_home/init.sql
Итог: Создал еще init.sql для микросервисного приложения описываемого во 2-4 заданиях  ./FitLife/init.sql
Проверил с Postman коллекцию smarthome-api.postman_collection.json и вызвать:
- Create Sensor
- Get All Sensors
Но у меня темература приходит 0 всегда, я у же все перепробывал. Прошу подсказать.

# **Задание 6. Разработка MVP**

Необходимо создать новые микросервисы и обеспечить их интеграции с существующим монолитом для плавного перехода к микросервисной архитектуре. 
Создал 2 миросервиса:
- для управления телеметрией без бд а с рандомными данными, проверил методы в Postman, возвращает данные камер. FitLife/src/main/surveillance"
- для управления ворот (т.к. для "устройств" в задании не ясно что значит, это все устройства.) FitLife/src/main/gates"

Не уверен что их получилось связать с основным сервисом. Контракты к методам взаимодействия с другими сервисами не были даны в задаче. А Оосновной сервис неаписан на GO и из его кода мне не ясно как должно быть устроено взаимодействие с другими сервисами.
Прошу в результате проверки подсветить мне мои ошибки.

docker-compose находится FitLife\src\main\docker-compose.yml
Dockerfiles присутсвует в каждом микросервисе
